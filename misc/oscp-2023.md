...
OSCP는 100% 실습 시험이기 때문에 무작정 열심히 _노오오력_만 하다보면 통과하지 못한다. 그렇기에 우리는 "_**Try Smarter"**_, "무작정 열심히가 아니라 똑똑하게 일하라"의 마인드로 똑똑하게 준비해야 한다.
...
따라서 통과하는 법(<mark style="color:red;">**How to pass**</mark>)이 아닌 통과하기 위한 최선의 준비 방법 (<mark style="color:blue;">**How to prepare**</mark>)은 다음과 같다.
...
3. AD 3개 박스 해킹 (40점) + 독립 박스 2개 해킹 (20점 x 2= 40점) = 80점으로 통과하기.&#x20;
